...
<div class="wrapper">
    <form action="InsertStudentServlet?user=${user}" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                <p>学号:</p>
                <p><input type="text" name="stuno" class="loginInput"  required="required" autofocus="autofocus" placeholder="请输入学号"/></p>
                <p>姓名:</p>
